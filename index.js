...
window.addEventListener('load', ()=> {
    ...
    form.addEventListener("submit", (e) => {
        ...
        task_check_el.innerHTML = '<i class="fa solid fa-check"></i>';

        const task_edit_el = document.createElement("button");
        task_edit_el.classList.add("edit");
        task_edit_el.innerHTML = '<i class="fa solid fa-edit"></i>';
        ...
        task_edit_el.addEventListener('click', () => {
            if (task_edit_el.classList == "edit") {
                task_input_el.removeAttribute("readonly");
                task_input_el.focus();
                task_edit_el.innerHTML = '<p>save</p>';
            }else if(task_edit_el.innerHTML = '<p>save</p>'){
                 task_input_el.setAttribute("readonly", "readonly");
                task_edit_el.innerHTML = '<i class="fa solid fa-edit"></i>';
            }
        });
